...
public class CommentController {
    ...
    @RequestMapping("room_comment_management.html")
    public ModelAndView roomCommentManagement(){
        ModelAndView mav = new ModelAndView("room_comment_management");
    ...
    public ModelAndView commentManagement(){
        List<Comment> commentList1 = commentService.getAllComments();
        ModelAndView mav = new ModelAndView("comment_management");
        mav.addObject("commentList", commentList1);
        return mav;
    }
    ...
    public Object deleteComment(@RequestParam("serNum") Integer serNum){
        ...
        // }
        HashMap<String, String> res = new HashMap<>();
        if (commentService.deleteByPrimaryKey(serNum)) {
            res.put("stateCode", "1");
        } else {
            res.put("stateCode", "0");
        }
