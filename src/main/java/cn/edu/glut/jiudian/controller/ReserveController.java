...
public class ReserveController {
    ...
    @RequestMapping("selectUserReservation")
    @ResponseBody
    public Object selectUserReservation(@RequestParam("userId") String userId){
        List<Reserve> reserveList = reserveService.selectUserReservation(userId);
        return reserveList;
    }
}
