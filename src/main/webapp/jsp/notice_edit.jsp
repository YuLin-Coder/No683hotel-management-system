    ...
    <form  id="addRoom">
        <div class="form-group">
            ...
            <textarea class="form-control" rows="3" name="notice" id="notice"
                      placeholder="请输入公告内容">${notice.notice}</textarea>
        </div>

        <input type="button" id="addRoomButton" value="提交" class="btn btn-success btn-sm" class="text-left">
        <input type="text" hidden id="serNum" class="text-left" value="${notice.serNum}">
