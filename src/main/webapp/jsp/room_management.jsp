...
<div class="panel panel-default" style="margin-top: -8px; margin-left: 20px; margin-right: 40px">
            ...
            <tbody>
                <c:forEach items="${roomList}" var="room">
                    <tr>
                        ...
                        <td><img src="<c:out value="${room.photoUrl}"></c:out>" width="50" height="50"/></td>
                        <td><c:out value="${room.area}"></c:out></td>
                        <td><c:out value="${room.price}"></c:out></td>
                        <td>
                            <a href="#">
                                <button onclick="roomCommentManagement('${room.roomId}')" type="button" class="btn btn-info btn-sm">
                                    管理评论
                                </button>
                            </a>
                        </td>
...
<script type="text/javascript">
    ...
    function roomCommentManagement(roomId) {
        $.ajax({
            type: 'post',
            url: 'geRoomComment',
            data: {
            ...
            success: function () {
                //$("#display").html("");
                $("#display").load('room_comment_management.html');
            }
        })
    }
