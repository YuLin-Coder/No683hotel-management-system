...
<div class="user-menu">
    ...
    <c:forEach items="${roomTypeList}" var="roomType">
        <a href="#typeId=<c:out value="${roomType.typeId}"></c:out>&type=<c:out value="${roomType.type}"></c:out>"
           onclick="showRoomListByType(this)" id="typeId<c:out value="${roomType.typeId}"></c:out>">${roomType.type}</a>
    </c:forEach>
</div>
<c:choose>
...
<div class="user-body">
        ...
        <div class="panel panel-default">
            ...
            <div class="room-detail" id="roomDetail">
                ...
                <div class="right-body" id="rightMsg">
                    ...
                    <p>简介：</p>
                    <p><textarea id="roomIntroduce" class="form-control" rows="3"
                                 style="background-color: white; font-size: 16px" disabled>环境优美，床褥舒适</textarea>
                    </p>
                    ...
                    <div class="comment-msg" style="margin-top: 25px; font-size: 21px">
                        <a href="#" onclick="readComment()" id="readComment"
                           style="float: left; margin-left: 95px"><span class="glyphicon glyphicon-eye-open"
                                                                        aria-hidden="true"></span>查看评论</a>
                        <a href="#" onclick="writeComment()" id="writeComment"
                           style="float: right; margin-right: 140px"><span class="glyphicon glyphicon-edit"
                                                                           aria-hidden="true"></span>我要评论</a>
                    </div>
                    ...
                    <div class="btn-group" style="margin-top: 65px">
                        <div class="col-xs-offset-2 col-xs-7">
                            <!-- 按钮触发模态框 -->
                            <button type="button" id="reserveButton" data-toggle="modal" data-target="#myModal">预定
                            </button>
                            <!-- 模态框（Modal） -->
            ...
            <div class="panel-body" id="roomsDisplay">
                <c:forEach items="${roomList}" var="room">
                    <div class="room-info">
                        <div class="img-info">
                            <img class="img-rounded" onclick="showRoomDetail(${room.roomId})" src="${room.photoUrl}"
    ...
    <div class="message">
                    ...
                    <form class="form-horizontal" id="userLoginForm">
                        ...
                        <div class="form-group" style="display: flex">
                            <div class="col-xs-offset-3 col-xs-8" style="margin-top: 20px">
                                <button type="button" class="btn" id="userLoginButton"
                                        style="background-color: #ff9000">登录
                                </button>
                            </div>
                            <div class="col-xs-12" style="margin-top: 20px">
                                <!-- 按钮触发模态框 -->
                                <button type="button" class="btn" id="userRegisterButton" data-toggle="modal"
                                        data-target="#userRegisterModal" style="background-color: #ff9000">注册
                                </button>
                                <!-- 模态框（Modal） -->
                                <div class="modal fade" id="userRegisterModal" tabindex="-1" role="dialog"
                                     aria-labelledby="userRegisterModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <form class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="registerPhone"
                                                               class="col-sm-2 col-sm-offset-2 control-label">手机号码:</label>
                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="registerEmail"
                                                               class="col-sm-2 col-sm-offset-2 control-label">邮箱:</label>
                                                        <div class="col-sm-6">
                                                            <input type="password" class="form-control"
                                                                   id="registerEmail">
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="registerQQ"
                                                               class="col-sm-2 col-sm-offset-2 control-label">QQ号码:</label>
                                                        <div class="col-sm-6">
                                                            <input type="password" class="form-control" id="registerQQ">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="registerPhotoUrl"
                                                               class="col-sm-2 col-sm-offset-2 control-label">头像:</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="registerAddress"
                                                               class="col-sm-2 col-sm-offset-2 control-label">家庭住址:</label>
                                                        <div class="col-sm-6">
                                                            <input type="password" class="form-control"
                                                                   id="registerAddress">
                                                        </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <c:forEach items="${noticeList}" var="notice">
                        <div>
                            <a href="#" onclick="noticeValue('<fmt:formatDate value="${notice.releaseTime}"
                                                                             type="date"/>','${notice.notice}')"
                    ...
                    <div class="modal fade" id="noticeModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        <p id="noticeContent" style="line-height: 25px; margin: 0;"></p>
                                    </form>
                                </div>
                            </div><!-- /.modal-content -->
                        </div><!-- /.modal-dialog -->
        ...
        <script type="text/javascript">
            function noticeValue(noticeDate, noticeContent) {
                $('#noticeModalLabel').text(noticeDate);
